...
export const Toast = ({message}: IToast) => {
    return (

        <div id="toast-default"
             className="flex items-center min-w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
             role="alert">
            <div
